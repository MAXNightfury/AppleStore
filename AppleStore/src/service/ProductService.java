...
public class ProductService implements IProductService {
    ...
    public void selectCategoryProduct(ProductVO productVO) {
        ...
        System.out.println("---------------------------------------");
        System.out.printf("%5s\t%7s\t%5s\t%7s", "제품ID", "제품이름", "제품가격", "남은수량");
        System.out.println();
        System.out.println("---------------------------------------");

        categoryProductArr = productDAO.selectCategoryProduct(productVO);
    ...
    public void selectProduct() { //TODO 이걸 왜 적어 놨을까?
    }
    ...
    public void selectPopularProduct() { // TODO 해수 테이블 밀고 다시 테스트
        ...
        System.out.println("------------------------------------------------");
        System.out.printf("%5s\t%7s\t%5s\t%7s\t7%s", "제품ID", "제품이름", "제품가격", "남은수량", "주문수량");
        System.out.println();
        System.out.println("------------------------------------------------");
